...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="user-info.html">个人信息</a>>>回复通知</span>回复通知</h2>
    <!-- 回复列表 -->
    <jsp:include page="user-revert-inform-list.jsp"></jsp:include>
  </div>
</div>
...
<script>
  $(function(){
    // 栏目标志
    $("#grxx-hftz a").css("color","white");
    $("#grxx-hftz").css("background","rgb(81, 164, 231)");
