...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="user-info.html">个人信息</a>>>我的帖子</span>我的帖子</h2>
    <!-- 帖子列表 -->
    <jsp:include page="user-my-post-list.jsp"></jsp:include>
  </div>
</div>
<script type="text/javascript" src="<%=basePath%>home/js/jquery-1.11.0.js"></script>
<script>
  $(function(){
    $("#grxx-wdtz a").css("color","white");
    $("#grxx-wdtz").css("background","rgb(81, 164, 231)");
    $("#show-from").hide();
    $(".show-required").hide();
