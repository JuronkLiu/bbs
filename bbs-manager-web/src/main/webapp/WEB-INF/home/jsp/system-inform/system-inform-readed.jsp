...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="system-inform.jsp">系统通知</a>>>已阅览</span>已阅览</h2>
    <!-- 未阅览列表 -->
    <jsp:include page="system-inform-readed-list.jsp"></jsp:include>
  </div>
</div>
...
<script>
  $(function(){
    ...
    // 栏目标志
    $("#xttz-yyl a").css("color","white");
    $("#xttz-yyl").css("background","rgb(81, 164, 231)");
